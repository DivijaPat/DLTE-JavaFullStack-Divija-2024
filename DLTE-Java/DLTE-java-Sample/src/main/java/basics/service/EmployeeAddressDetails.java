...
public class EmployeeAddressDetails {
    private String permanentHouseName,permanentStreet,permanentCity,permanentState,temporaryHouseName,temporaryStreet,temporaryCity,temporaryState;
    private int temporaryPinCode,permanentPinCode;
