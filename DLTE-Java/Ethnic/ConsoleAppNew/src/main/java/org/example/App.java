...
public class App {
    public static void main(String[] args) throws InvalidCredentialsException, AccountNotFoundException, IOException {
...
//           else System.out.println("Failed");
        ...
        System.out.println(authenticationMiddleware.authenticate("divija","1234"));
        System.out.println(authenticationMiddleware.getAccountByUsername("medhini"));
        authenticationMiddleware.updateAccountBalance("divija",37000);
        System.out.println(authenticationMiddleware.getAllAccounts());
