 ...
 * 
 */
@WebServiceClient(name = "MySourceService", targetNamespace = "http://soap.or/", wsdlLocation = "http://localhost:6543/demo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSOURCESERVICE_QNAME = new QName("http://soap.or/", "MySourceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:6543/demo?wsdl");
    ...
    public MySource getMySourcePort() {
        return super.getPort(new QName("http://soap.or/", "MySourcePort"), MySource.class);
    }
    ...
    public MySource getMySourcePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.or/", "MySourcePort"), MySource.class, features);
    }
