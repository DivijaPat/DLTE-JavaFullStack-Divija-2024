    ...
    public static void main(String[] args) {
        ...
        switch (option) {
            ...
            case 3:
                ...
                creditCardPin = scanner.nextInt();
                for (CreditCard each : myBank) {
                    if (each.getCreditCardNumber().equals(creditCardNumber) && each.getCreditCardPin().equals(creditCardPin)) {
                        support.updatePin(myBank,creditCardNumber);
                        incorrectLogin = 0;
                    }
                }
                if (incorrectLogin == 1) System.out.println("data provided is incorrect");
                break;
            case 4:
                 ...
                 for(CreditCard each:myBank) {
                    if (each.getDateOfBillGeneration().getDate() == 5) {
                       // System.out.println("enter the limit");
                        ...
                        System.out.println(each.getCreditCardHolder() + " Congrats! your card limit is updated. Your new limit is " + extendLimit);
                    }
                }
                break;
        }
