package mybank.insurance.webservice.security;//package com.payment.webservices.security;//package springjdbc.transaction.demo.security;
...
public class MyBankUsersServices implements UserDetailsService {
    ...
    public MyBankUsers signUp(MyBankUsers myBankUsers){
       jdbcTemplate.update("insert into  MYBANK_APP_USERS values(?,?,?,?,?,?)",new Object[]{
