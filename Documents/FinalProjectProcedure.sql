...
--    fetch_insurance_data(30000, 50000, v_insurance_data);
--    
...
--    insuranceData OUT SYS_REFCURSOR
--) AS
--    v_check_rec mybank_app_insuranceavailed%ROWTYPE; -- Temporary variable to check data
--    v_data_exists BOOLEAN := FALSE; -- Flag to check if data exists
--BEGIN
--    -- First, open a cursor for the check
--    OPEN insuranceData FOR
--        SELECT INSURANCE_AVAIL_ID, INSURANCE_ID, CUSTOMER_ID, INSURANCE_PREMIUM,
--               INSURANCE_TYPE, INSURANCE_NAME, INSURANCE_KEY_BENEFITS, INSURANCE_LIFETIME
--        FROM mybank_app_insuranceavailed
...
--    FETCH insuranceData INTO v_check_rec;
--    IF insuranceData%FOUND THEN
--        v_data_exists := TRUE;
--    END IF;
--    CLOSE insuranceData;
--
--    -- Reopen cursor if data exists
...
EXECUTE fetch_insurance_data(3000, 5000, :insuranceData);
print insurancedata
